...
class ComList extends Component {
  ...
  render() {
    const coms = this.props.coms
      ...
      .filter((com) => com.config.name || !this.props.configLocked);
          ...
          >
            <div
              ...
              onClick={() => {
                ...
                if (!com.config.average && com.config.entries > 0) {
            ...
            >
              <div className="center">
                <FitText>
                  <div>{com.config.name}</div>
                </FitText>
                <FitText compressor={2}>
                  <div>{com.config.average && `Average ${com.config.entries}`}</div>
                </FitText>
              </div>
            </div>
            <div
              className={classNames("comElement--content", {
                "comElement--content--testMode": com.config.mode === "test",
              ...
              {this.state.showHistory[com.index] && com.history ? (
                ...
                <div className="center">
                  <FitText compressor={0.9}>
                    <div>{com.config.average ? com.average : com.entry}</div>
                  </FitText>
                </div>
              )}
            </div>
